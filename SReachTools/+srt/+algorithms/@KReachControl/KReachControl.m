...
% KReachControl Kernel distribution embeddings.
    ...
    properties (Hidden, Dependent)
        % X State samples.
        %
        %   If you pass samples into KReachControl manually, make sure they are
        %   in column format and that the matrix has the dimensions [nxM], where
        %   n is the dimensionality of the state and M is the number of samples:
        %
        %   [ | | |     ]
        %   [ x x x ... ]
        %   [ | | |     ]
        ...
        %
        %   If you pass samples into KReachControl manually, make sure they are
        %   in column format and that the matrix has the dimensions [mxM], where
        %   m is the dimensionality of the input and M is the number of samples:
        %
        %   [ | | |     ]
        %   [ u u u ... ]
        %   [ | | |     ]
        ...
        %
        %   If you pass samples into KReachControl manually, make sure they are
        %   in column format and that the matrix has the dimensions [pxM], where
        %   p is the dimensionality of the disturbance and M is the number of
        %   samples:
        %
        %   [ | | |     ]
        %   [ w w w ... ]
