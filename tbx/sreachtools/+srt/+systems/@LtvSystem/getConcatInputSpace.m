...
% ============================================================================
%
% Computes the InputSpace^{time_horizon} corresponding to a given set, which
...
%
    ...
    %% Construction of the concatenated input space (InputSpace^{time_horizon})
    concat_input_space_A = kron(eye(time_horizon), sys.InputSpace.A);
    concat_input_space_b = kron(ones(time_horizon,1), sys.InputSpace.b);
end
